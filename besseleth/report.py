...
{% endif %}
---
_Generated by besseleth on {{ generated_at }}. {{ item_count }} items scanned this week. Full history — every past report and the complete trends dataset — lives in the [browser dashboard](http://127.0.0.1:5050), not just this snapshot._
"""
